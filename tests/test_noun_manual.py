...
class TestNouns(unittest.TestCase):
    ...
    def test_classical_cache(self):
        ...
        self.assertEqual(classical_one, classical_two, "Cache of Noun(...).classical()")
    ...
    def test_classical_modern(self):
        ...
        self.assertEqual(noun, modern, "Noun(...) = Noun(...).classical().modern()")
    ...
    def test_is_singular_not_plural(self):
        ...
        for sing in test_data:
            with self.subTest():
                self.assertTrue(
                    Noun(sing).is_singular(), f"Noun({sing!r}).is_singular() => True"
                )
                self.assertFalse(
                    Noun(sing).is_plural(), f"Noun({sing!r}).is_plural() => False"
                )
    ...
    def test_is_plural_not_singular(self):
        ...
        for sing in test_data:
            with self.subTest():
                self.assertTrue(
                    Noun(sing).is_plural(), f"Noun({sing!r}).is_plural() => True"
                )
                self.assertFalse(
                    Noun(sing).is_singular(), f"Noun({sing!r}).is_singular() => False"
                )
