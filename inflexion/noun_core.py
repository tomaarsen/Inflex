...
modern_plural_convert_rules = {
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-{match.group(2)}-{match.group(3)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} {match.group(2)} {match.group(3)}"},
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-{match.group(2)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} {match.group(2)}"},
    rei(r"^(.+)star general$"): {"output": lambda match: f"{match.group(1)}star generals"},
    rei(r"^(.*)phenomenon$"): {"output": lambda match: f"{match.group(1)}phenomena"},
    rei(r"^(.*)wildebeest$"): {"output": lambda match: f"{match.group(1)}wildebeests"},
    rei(r"^(.*)proboscis$"): {"output": lambda match: f"{match.group(1)}proboscises"},
    rei(r"^(.*)legomenon$"): {"output": lambda match: f"{match.group(1)}legomena"},
    rei(r"^son-of-a-(.*?)$"): {"output": lambda match: f"sons-of-{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}"},
    rei(r"^son of a (.*?)$"): {"output": lambda match: f"sons of {convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}"},
    rei(r"^(.*)bacillus$"): {"output": lambda match: f"{match.group(1)}bacilli"},
    rei(r"^(.*?)-general$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-general"},
    rei(r"^(.*?) general$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} general"},
    rei(r"^(.*)siemens$"): {"output": lambda match: f"{match.group(1)}siemens"},
    rei(r"^(.*)brother$"): {"output": lambda match: f"{match.group(1)}brothers"},
    rei(r"^(.*)sarcoma$"): {"output": lambda match: f"{match.group(1)}sarcomas"},
    rei(r"^(.*)stratum$"): {"output": lambda match: f"{match.group(1)}stratums"},
    rei(r"^(.*)nucleus$"): {"output": lambda match: f"{match.group(1)}nuclei"},
    rei(r"^(.*)measles$"): {"output": lambda match: f"{match.group(1)}measles"},
    rei(r"^(.*?)-errant$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-errant"},
    rei(r"^(.*?) errant$"): {"output": lambda match: f"{convert_to_modern_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} errant"},
    rei(r"^(.*)person$"): {"output": lambda match: f"{match.group(1)}people"},
    rei(r"^(.*)mensch$"): {"output": lambda match: f"{match.group(1)}menschen"},
    rei(r"^(.*)hedron$"): {"output": lambda match: f"{match.group(1)}hedrons"},
    rei(r"^(.*)helion$"): {"output": lambda match: f"{match.group(1)}helions"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{match.group(1)}-{convert_to_modern_plural(match.group(2)) if is_singular(match.group(2)) else match.group(2)}"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{match.group(1)} {convert_to_modern_plural(match.group(2)) if is_singular(match.group(2)) else match.group(2)}"},
    rei(r"^(.*)staff$"): {"output": lambda match: f"{match.group(1)}staffs"},
    rei(r"^(.*)stave$"): {"output": lambda match: f"{match.group(1)}staves"},
    rei(r"^(.*)genus$"): {"output": lambda match: f"{match.group(1)}genera"},
    rei(r"^(.*)hertz$"): {"output": lambda match: f"{match.group(1)}hertz"},
    rei(r"^(.*)child$"): {"output": lambda match: f"{match.group(1)}children"},
    rei(r"^(.*)knife$"): {"output": lambda match: f"{match.group(1)}knives"},
    rei(r"^(.*)shelf$"): {"output": lambda match: f"{match.group(1)}shelves"},
    rei(r"^(.*)thief$"): {"output": lambda match: f"{match.group(1)}thieves"},
    rei(r"^(.*)human$"): {"output": lambda match: f"{match.group(1)}humans"},
    rei(r"^(.*)goose$"): {"output": lambda match: f"{match.group(1)}geese"},
    rei(r"^(.*)mouse$"): {"output": lambda match: f"{match.group(1)}mice"},
    rei(r"^(.*)tooth$"): {"output": lambda match: f"{match.group(1)}teeth"},
    rei(r"^(.*)frizz$"): {"output": lambda match: f"{match.group(1)}frizzes"},
    rei(r"^(.*)drama$"): {"output": lambda match: f"{match.group(1)}dramas"},
    rei(r"^(.*)edema$"): {"output": lambda match: f"{match.group(1)}edemas"},
    rei(r"^(.*)lemma$"): {"output": lambda match: f"{match.group(1)}lemmas"},
    rei(r"^(.*)stoma$"): {"output": lambda match: f"{match.group(1)}stomas"},
    rei(r"^(.*)umbra$"): {"output": lambda match: f"{match.group(1)}umbras"},
    rei(r"^(.*)lumen$"): {"output": lambda match: f"{match.group(1)}lumens"},
    rei(r"^(.*)datum$"): {"output": lambda match: f"{match.group(1)}data"},
    rei(r"^(.*)helix$"): {"output": lambda match: f"{match.group(1)}helices"},
    rei(r"^(.*)sheep$"): {"output": lambda match: f"{match.group(1)}sheep"},
    rei(r"^(.*)craft$"): {"output": lambda match: f"{match.group(1)}craft"},
    rei(r"^(.*)hoof$"): {"output": lambda match: f"{match.group(1)}hoofs"},
    rei(r"^(.*)leaf$"): {"output": lambda match: f"{match.group(1)}leaves"},
    rei(r"^(.*)life$"): {"output": lambda match: f"{match.group(1)}lives"},
    rei(r"^(.*)loaf$"): {"output": lambda match: f"{match.group(1)}loaves"},
    rei(r"^(.*)wife$"): {"output": lambda match: f"{match.group(1)}wives"},
    rei(r"^(.*)wolf$"): {"output": lambda match: f"{match.group(1)}wolves"},
    rei(r"^(.*)foot$"): {"output": lambda match: f"{match.group(1)}feet"},
    rei(r"^(.*)buzz$"): {"output": lambda match: f"{match.group(1)}buzzes"},
    rei(r"^(.*)fizz$"): {"output": lambda match: f"{match.group(1)}fizzes"},
    rei(r"^(.*)fuzz$"): {"output": lambda match: f"{match.group(1)}fuzzes"},
    rei(r"^(.*)jazz$"): {"output": lambda match: f"{match.group(1)}jazzes"},
    rei(r"^(.*)bema$"): {"output": lambda match: f"{match.group(1)}bemas"},
    rei(r"^(.*)nova$"): {"output": lambda match: f"{match.group(1)}novas"},
    rei(r"^(.*)bass$"): {"output": lambda match: f"{match.group(1)}basses"},
    rei(r"^(.*)deer$"): {"output": lambda match: f"{match.group(1)}deer"},
    rei(r"^(.*)fish$"): {"output": lambda match: f"{match.group(1)}fish"},
    rei(r"^(.*)fowl$"): {"output": lambda match: f"{match.group(1)}fowls"},
    rei(r"^(.+)ceps$"): {"output": lambda match: f"{match.group(1)}ceps"},
    rei(r"^(.+)nife$"): {"output": lambda match: f"{match.group(1)}nives"},
    rei(r"^(.+)orse$"): {"output": lambda match: f"{match.group(1)}orses"},
    rei(r"^(.+[au])orse$"): {"output": lambda match: f"{match.group(1)}orses"},
    rei(r"^(.+)trix$"): {"output": lambda match: f"{match.group(1)}trixes"},
    rei(r"^(.+)zoon$"): {"output": lambda match: f"{match.group(1)}zoa"},
    rei(r"^(.*?)'s?$"): {
        "conditional": lambda match: is_singular(match.group(1)),
        "output": lambda match: convert_to_modern_plural(match.group(1)) + '\'' if convert_to_modern_plural(match.group(1)).endswith('s') else convert_to_modern_plural(match.group(1)) + '\'s'
    },
    rei(r"^(.*)cow$"): {"output": lambda match: f"{match.group(1)}cows"},
    rei(r"^(.+)-ox$"): {"output": lambda match: f"{match.group(1)}-oxen"},
    rei(r"^(.*)elf$"): {"output": lambda match: f"{match.group(1)}elves"},
    ...
    rei(r"^(.+)ieu$"): {"output": lambda match: f"{match.group(1)}ieus"},
    ...
    rei(r"^(.+)ss$"): {"output": lambda match: f"{match.group(1)}sses"},
    ...
    rei(r"^(.+)z$"): {"output": lambda match: f"{match.group(1)}zzes"},
    rei(r"^(.+)s$"): {"output": lambda match: f"{match.group(1)}ses"},
    rei(r"^(.+)$"): {"output": lambda match: f"{match.group(1)}s"},
}

classical_plural_convert_rules = {
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-{match.group(2)}-{match.group(3)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} {match.group(2)} {match.group(3)}"},
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-{match.group(2)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} {match.group(2)}"},
    rei(r"^(.+)star general$"): {"output": lambda match: f"{match.group(1)}star generals"},
    rei(r"^(.*)phenomenon$"): {"output": lambda match: f"{match.group(1)}phenomena"},
    rei(r"^(.*)wildebeest$"): {"output": lambda match: f"{match.group(1)}wildebeest"},
    rei(r"^(.*)proboscis$"): {"output": lambda match: f"{match.group(1)}proboscides"},
    rei(r"^(.*)legomenon$"): {"output": lambda match: f"{match.group(1)}legomena"},
    rei(r"^son-of-a-(.*?)$"): {"output": lambda match: f"sons-of-{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}"},
    rei(r"^son of a (.*?)$"): {"output": lambda match: f"sons of {convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}"},
    rei(r"^(.*)bacillus$"): {"output": lambda match: f"{match.group(1)}bacilli"},
    rei(r"^(.*?)-general$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-general"},
    rei(r"^(.*?) general$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} general"},
    rei(r"^(.*)siemens$"): {"output": lambda match: f"{match.group(1)}siemens"},
    rei(r"^(.*)brother$"): {"output": lambda match: f"{match.group(1)}brethren"},
    rei(r"^(.*)sarcoma$"): {"output": lambda match: f"{match.group(1)}sarcomata"},
    rei(r"^(.*)stratum$"): {"output": lambda match: f"{match.group(1)}strata"},
    rei(r"^(.*)nucleus$"): {"output": lambda match: f"{match.group(1)}nuclei"},
    rei(r"^(.*)measles$"): {"output": lambda match: f"{match.group(1)}measles"},
    rei(r"^(.*?)-errant$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)}-errant"},
    rei(r"^(.*?) errant$"): {"output": lambda match: f"{convert_to_classical_plural(match.group(1)) if is_singular(match.group(1)) else match.group(1)} errant"},
    rei(r"^(.*)person$"): {"output": lambda match: f"{match.group(1)}persons"},
    rei(r"^(.*)mensch$"): {"output": lambda match: f"{match.group(1)}menschen"},
    rei(r"^(.*)hedron$"): {"output": lambda match: f"{match.group(1)}hedra"},
    rei(r"^(.*)helion$"): {"output": lambda match: f"{match.group(1)}helia"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{match.group(1)}-{convert_to_classical_plural(match.group(2)) if is_singular(match.group(2)) else match.group(2)}"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{match.group(1)} {convert_to_classical_plural(match.group(2)) if is_singular(match.group(2)) else match.group(2)}"},
    rei(r"^(.*)staff$"): {"output": lambda match: f"{match.group(1)}staves"},
    rei(r"^(.*)stave$"): {"output": lambda match: f"{match.group(1)}staves"},
    rei(r"^(.*)genus$"): {"output": lambda match: f"{match.group(1)}genera"},
    rei(r"^(.*)hertz$"): {"output": lambda match: f"{match.group(1)}hertz"},
    rei(r"^(.*)child$"): {"output": lambda match: f"{match.group(1)}children"},
    ...
    rei(r"^(.*)frizz$"): {"output": lambda match: f"{match.group(1)}frizzes"},
    rei(r"^(.*)drama$"): {"output": lambda match: f"{match.group(1)}dramas"},
    rei(r"^(.*)edema$"): {"output": lambda match: f"{match.group(1)}edemata"},
    rei(r"^(.*)lemma$"): {"output": lambda match: f"{match.group(1)}lemmata"},
    rei(r"^(.*)stoma$"): {"output": lambda match: f"{match.group(1)}stomata"},
    rei(r"^(.*)umbra$"): {"output": lambda match: f"{match.group(1)}umbrae"},
    rei(r"^(.*)lumen$"): {"output": lambda match: f"{match.group(1)}lumina"},
    rei(r"^(.*)datum$"): {"output": lambda match: f"{match.group(1)}data"},
    rei(r"^(.*)helix$"): {"output": lambda match: f"{match.group(1)}helices"},
    rei(r"^(.*)sheep$"): {"output": lambda match: f"{match.group(1)}sheep"},
    rei(r"^(.*)craft$"): {"output": lambda match: f"{match.group(1)}craft"},
    rei(r"^(.*)hoof$"): {"output": lambda match: f"{match.group(1)}hooves"},
    rei(r"^(.*)leaf$"): {"output": lambda match: f"{match.group(1)}leaves"},
    rei(r"^(.*)life$"): {"output": lambda match: f"{match.group(1)}lives"},
    rei(r"^(.*)loaf$"): {"output": lambda match: f"{match.group(1)}loaves"},
    rei(r"^(.*)wife$"): {"output": lambda match: f"{match.group(1)}wives"},
    ...
    rei(r"^(.*)fuzz$"): {"output": lambda match: f"{match.group(1)}fuzzes"},
    rei(r"^(.*)jazz$"): {"output": lambda match: f"{match.group(1)}jazzes"},
    rei(r"^(.*)bema$"): {"output": lambda match: f"{match.group(1)}bemata"},
    rei(r"^(.*)nova$"): {"output": lambda match: f"{match.group(1)}novae"},
    rei(r"^(.*)bass$"): {"output": lambda match: f"{match.group(1)}bass"},
    rei(r"^(.*)deer$"): {"output": lambda match: f"{match.group(1)}deer"},
    rei(r"^(.*)fish$"): {"output": lambda match: f"{match.group(1)}fish"},
    rei(r"^(.*)fowl$"): {"output": lambda match: f"{match.group(1)}fowl"},
    rei(r"^(.+)ceps$"): {"output": lambda match: f"{match.group(1)}ceps"},
    rei(r"^(.+)nife$"): {"output": lambda match: f"{match.group(1)}nives"},
    rei(r"^(.+)orse$"): {"output": lambda match: f"{match.group(1)}orses"},
    rei(r"^(.+[au])orse$"): {"output": lambda match: f"{match.group(1)}orses"},
    rei(r"^(.+)trix$"): {"output": lambda match: f"{match.group(1)}trices"},
    rei(r"^(.+)zoon$"): {"output": lambda match: f"{match.group(1)}zoa"},
    rei(r"^(.*?)'s?$"): {
        "conditional": lambda match: is_singular(match.group(1)),
        "output": lambda match: convert_to_classical_plural(match.group(1)) + '\'' if convert_to_classical_plural(match.group(1)).endswith('s') else convert_to_classical_plural(match.group(1)) + '\'s'
    },
    rei(r"^(.*)cow$"): {"output": lambda match: f"{match.group(1)}kine"},
    rei(r"^(.+)-ox$"): {"output": lambda match: f"{match.group(1)}-oxen"},
    rei(r"^(.*)elf$"): {"output": lambda match: f"{match.group(1)}elves"},
    rei(r"^(.*)man$"): {"output": lambda match: f"{match.group(1)}men"},
    rei(r"^(.*)pox$"): {"output": lambda match: f"{match.group(1)}pox"},
    ...
    rei(r"^(.+)ieu$"): {"output": lambda match: f"{match.group(1)}ieux"},
    rei(r"^(.+)quy$"): {"output": lambda match: f"{match.group(1)}quies"},
    rei(r"^(.+)nse$"): {"output": lambda match: f"{match.group(1)}nses"},
    rei(r"^(.+[^ns])sis$"): {"output": lambda match: f"{match.group(1)}ses"},
    rei(r"^(.+[aeiou])se$"): {"output": lambda match: f"{match.group(1)}ses"},
...
singular_convert_rules = {
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}-{match.group(2)}-{match.group(3)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)} {match.group(2)} {match.group(3)}"},
    rei(r"^(.*?)-(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}-{match.group(2)}"},
    rei(r"^(.*?) (about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)} {match.group(2)}"},
    rei(r"^(.+)star generals$"): {"output": lambda match: f"{match.group(1)}star general"},
    rei(r"^(.*)proboscises$"): {"output": lambda match: f"{match.group(1)}proboscis"},
    rei(r"^(.*)proboscides$"): {"output": lambda match: f"{match.group(1)}proboscis"},
    rei(r"^(.*)wildebeests$"): {"output": lambda match: f"{match.group(1)}wildebeest"},
    rei(r"^(.*)wildebeest$"): {"output": lambda match: f"{match.group(1)}wildebeest"},
    rei(r"^(.*)sarcomata$"): {"output": lambda match: f"{match.group(1)}sarcoma"},
    rei(r"^(.*)phenomena$"): {"output": lambda match: f"{match.group(1)}phenomenon"},
    rei(r"^(.*)brothers$"): {"output": lambda match: f"{match.group(1)}brother"},
    rei(r"^(.*)brethren$"): {"output": lambda match: f"{match.group(1)}brother"},
    rei(r"^(.*)children$"): {"output": lambda match: f"{match.group(1)}child"},
    rei(r"^(.*)menschen$"): {"output": lambda match: f"{match.group(1)}mensch"},
    rei(r"^(.*)sarcomas$"): {"output": lambda match: f"{match.group(1)}sarcoma"},
    rei(r"^(.*)stratums$"): {"output": lambda match: f"{match.group(1)}stratum"},
    rei(r"^(.*)legomena$"): {"output": lambda match: f"{match.group(1)}legomenon"},
    rei(r"^(.*?)-general$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}-general"},
    rei(r"^(.*?) general$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)} general"},
    rei(r"^sons-of-(.*?)$"): {"output": lambda match: f"son-of-a-{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}"},
    rei(r"^sons of (.*?)$"): {"output": lambda match: f"son of a {convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}"},
    rei(r"^(.*)persons$"): {"output": lambda match: f"{match.group(1)}person"},
    rei(r"^(.*)siemens$"): {"output": lambda match: f"{match.group(1)}siemens"},
    rei(r"^(.*)shelves$"): {"output": lambda match: f"{match.group(1)}shelf"},
    rei(r"^(.*)thieves$"): {"output": lambda match: f"{match.group(1)}thief"},
    rei(r"^(.*)frizzes$"): {"output": lambda match: f"{match.group(1)}frizz"},
    rei(r"^(.*)edemata$"): {"output": lambda match: f"{match.group(1)}edema"},
    rei(r"^(.*)lemmata$"): {"output": lambda match: f"{match.group(1)}lemma"},
    rei(r"^(.*)stomata$"): {"output": lambda match: f"{match.group(1)}stoma"},
    rei(r"^(.*)bacilli$"): {"output": lambda match: f"{match.group(1)}bacillus"},
    rei(r"^(.*)hedrons$"): {"output": lambda match: f"{match.group(1)}hedron"},
    rei(r"^(.*)helions$"): {"output": lambda match: f"{match.group(1)}helion"},
    rei(r"^(.*)helices$"): {"output": lambda match: f"{match.group(1)}helix"},
    rei(r"^(.*)measles$"): {"output": lambda match: f"{match.group(1)}measles"},
    rei(r"^(.*?)-errant$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)}-errant"},
    rei(r"^(.*?) errant$"): {"output": lambda match: f"{convert_to_singular(match.group(1)) if is_plural(match.group(1)) else match.group(1)} errant"},
    ...
    rei(r"^(.*)hooves$"): {"output": lambda match: f"{match.group(1)}hoof"},
    rei(r"^(.*)knives$"): {"output": lambda match: f"{match.group(1)}knife"},
    rei(r"^(.*)leaves$"): {"output": lambda match: f"{match.group(1)}leaf"},
    rei(r"^(.*)loaves$"): {"output": lambda match: f"{match.group(1)}loaf"},
    rei(r"^(.*)wolves$"): {"output": lambda match: f"{match.group(1)}wolf"},
    rei(r"^(.*)humans$"): {"output": lambda match: f"{match.group(1)}human"},
    rei(r"^(.*)buzzes$"): {"output": lambda match: f"{match.group(1)}buzz"},
    rei(r"^(.*)fizzes$"): {"output": lambda match: f"{match.group(1)}fizz"},
    rei(r"^(.*)fuzzes$"): {"output": lambda match: f"{match.group(1)}fuzz"},
    rei(r"^(.*)jazzes$"): {"output": lambda match: f"{match.group(1)}jazz"},
    rei(r"^(.*)bemata$"): {"output": lambda match: f"{match.group(1)}bema"},
    rei(r"^(.*)dramas$"): {"output": lambda match: f"{match.group(1)}drama"},
    rei(r"^(.*)edemas$"): {"output": lambda match: f"{match.group(1)}edema"},
    rei(r"^(.*)lemmas$"): {"output": lambda match: f"{match.group(1)}lemma"},
    rei(r"^(.*)stomas$"): {"output": lambda match: f"{match.group(1)}stoma"},
    rei(r"^(.*)umbras$"): {"output": lambda match: f"{match.group(1)}umbra"},
    rei(r"^(.*)umbrae$"): {"output": lambda match: f"{match.group(1)}umbra"},
    rei(r"^(.*)lumens$"): {"output": lambda match: f"{match.group(1)}lumen"},
    rei(r"^(.*)lumina$"): {"output": lambda match: f"{match.group(1)}lumen"},
    rei(r"^(.*)strata$"): {"output": lambda match: f"{match.group(1)}stratum"},
    rei(r"^(.*)nuclei$"): {"output": lambda match: f"{match.group(1)}nucleus"},
    rei(r"^(.*)basses$"): {"output": lambda match: f"{match.group(1)}bass"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with)-(.*?)$"): {"output": lambda match: f"{match.group(1)}-{convert_to_singular(match.group(2)) if is_plural(match.group(2)) else match.group(2)}"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) (.*?)$"): {"output": lambda match: f"{match.group(1)} {convert_to_singular(match.group(2)) if is_plural(match.group(2)) else match.group(2)}"},
    rei(r"^(.+)trixes$"): {"output": lambda match: f"{match.group(1)}trix"},
    rei(r"^(.+)trices$"): {"output": lambda match: f"{match.group(1)}trix"},
    rei(r"^(.*)hertz$"): {"output": lambda match: f"{match.group(1)}hertz"},
    rei(r"^(.+)-oxen$"): {"output": lambda match: f"{match.group(1)}-ox"},
    rei(r"^(.*)elves$"): {"output": lambda match: f"{match.group(1)}elf"},
    rei(r"^(.*)hoofs$"): {"output": lambda match: f"{match.group(1)}hoof"},
    rei(r"^(.*)lives$"): {"output": lambda match: f"{match.group(1)}life"},
    rei(r"^(.*)wives$"): {"output": lambda match: f"{match.group(1)}wife"},
    rei(r"^(.*)geese$"): {"output": lambda match: f"{match.group(1)}goose"},
    rei(r"^(.*)teeth$"): {"output": lambda match: f"{match.group(1)}tooth"},
    rei(r"^(.*)bemas$"): {"output": lambda match: f"{match.group(1)}bema"},
    rei(r"^(.*)novas$"): {"output": lambda match: f"{match.group(1)}nova"},
    rei(r"^(.*)novae$"): {"output": lambda match: f"{match.group(1)}nova"},
    rei(r"^(.*)hedra$"): {"output": lambda match: f"{match.group(1)}hedron"},
    rei(r"^(.*)helia$"): {"output": lambda match: f"{match.group(1)}helion"},
    rei(r"^(.*)fowls$"): {"output": lambda match: f"{match.group(1)}fowl"},
    rei(r"^(.*)sheep$"): {"output": lambda match: f"{match.group(1)}sheep"},
    rei(r"^(.*)craft$"): {"output": lambda match: f"{match.group(1)}craft"},
    rei(r"^(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) them$"): {"output": lambda match: f"{match.group(1)} it"},
    rei(r"^(.+)arves$"): {"output": lambda match: f"{match.group(1)}arf"},
    rei(r"^(.+)eaves$"): {"output": lambda match: f"{match.group(1)}eaf"},
    rei(r"^(.+)nives$"): {"output": lambda match: f"{match.group(1)}nife"},
    rei(r"^(.+)quies$"): {"output": lambda match: f"{match.group(1)}quy"},
    rei(r"^(.+)orses$"): {"output": lambda match: f"{match.group(1)}orse"},
    rei(r"^(.+[au])orses$"): {"output": lambda match: f"{match.group(1)}orse"},
    rei(r"^(.*)cows$"): {"output": lambda match: f"{match.group(1)}cow"},
    rei(r"^(.*)kine$"): {"output": lambda match: f"{match.group(1)}cow"},
    rei(r"^(.*)feet$"): {"output": lambda match: f"{match.group(1)}foot"},
    rei(r"^(.*)mice$"): {"output": lambda match: f"{match.group(1)}mouse"},
    rei(r"^(.*)data$"): {"output": lambda match: f"{match.group(1)}datum"},
    rei(r"^(.*)bass$"): {"output": lambda match: f"{match.group(1)}bass"},
    rei(r"^(.*)deer$"): {"output": lambda match: f"{match.group(1)}deer"},
    rei(r"^(.*)fish$"): {"output": lambda match: f"{match.group(1)}fish"},
    rei(r"^(.*)fowl$"): {"output": lambda match: f"{match.group(1)}fowl"},
    rei(r"^(.+[aeo])lves$"): {"output": lambda match: f"{match.group(1)}lf"},
    rei(r"^(.+[aiy])nxes$"): {"output": lambda match: f"{match.group(1)}nx"},
    rei(r"^(.+[aiy])nges$"): {"output": lambda match: f"{match.group(1)}nx"},
    rei(r"^(.+)ceps$"): {"output": lambda match: f"{match.group(1)}ceps"},
    rei(r"^(.+)eaus$"): {"output": lambda match: f"{match.group(1)}eau"},
    rei(r"^(.+)eaux$"): {"output": lambda match: f"{match.group(1)}eau"},
    rei(r"^(.+)ieus$"): {"output": lambda match: f"{match.group(1)}ieu"},
    rei(r"^(.+)ieux$"): {"output": lambda match: f"{match.group(1)}ieu"},
    rei(r"^(.+)sses$"): {"output": lambda match: f"{match.group(1)}ss"},
    rei(r"^(.+)nses$"): {"output": lambda match: f"{match.group(1)}nse"},
    rei(r"^(.+)uses$"): {"output": lambda match: f"{match.group(1)}us"},
    rei(r"^(.+)zzes$"): {"output": lambda match: f"{match.group(1)}z"},
    rei(r"^(.*?)'s?$"): {
        "conditional": lambda match: is_plural(match.group(1)),
        "output": lambda match: convert_to_singular(match.group(1)) + '\'' if convert_to_singular(match.group(1)).endswith('s') else convert_to_singular(match.group(1)) + '\'s'
    },
    ...
    rei(r"^(.+)xes$"): {"output": lambda match: f"{match.group(1)}x"},
    rei(r"^(.+)ies$"): {"output": lambda match: f"{match.group(1)}y"},
...
plural_recognize_rules = {
    rei(r"^(?:(.+[aeiou])os|(.+)os|(.+[aeiou])ys|(.*?)'s?|(.*)men|(.*)pox|(.+[aeiou])ses|(.+)oux|(.+[cs])hes|(.+)oes|(.+[^ns])ses|(.+)xes|(.+)ies|(.+)zoa|(.*)cows|(.*)kine|(.*)feet|(.*)mice|(.*)data|(.*)bass|(.*)deer|(.*)fish|(.*)fowl|(.+[aeo])lves|(.+[aiy])nxes|(.+[aiy])nges|(.+)ceps|(.+)eaus|(.+)eaux|(.+)ieus|(.+)ieux|(.+)sses|(.+)nses|(.+)uses|(.+)zzes|(.*)hertz|(.+)-oxen|(.*)elves|(.*)hoofs|(.*)lives|(.*)wives|(.*)geese|(.*)teeth|(.*)bemas|(.*)novas|(.*)novae|(.*)hedra|(.*)helia|(.*)fowls|(.*)sheep|(.*)craft|(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) them|(.+)arves|(.+)eaves|(.+)nives|(.+)quies|(.+)orses|(.+[au])orses|(.*)staffs|(.*)staves|(.*)genera|(.*)people|(.*)hooves|(.*)knives|(.*)leaves|(.*)loaves|(.*)wolves|(.*)humans|(.*)buzzes|(.*)fizzes|(.*)fuzzes|(.*)jazzes|(.*)bemata|(.*)dramas|(.*)edemas|(.*)lemmas|(.*)stomas|(.*)umbras|(.*)umbrae|(.*)lumens|(.*)lumina|(.*)strata|(.*)nuclei|(.*)basses|(.+)trixes|(.+)trices|(.*)persons|(.*)siemens|(.*)shelves|(.*)thieves|(.*)frizzes|(.*)edemata|(.*)lemmata|(.*)stomata|(.*)bacilli|(.*)hedrons|(.*)helions|(.*)helices|(.*)measles|(.*)brothers|(.*)brethren|(.*)children|(.*)menschen|(.*)sarcomas|(.*)stratums|(.*)legomena|(.*)sarcomata|(.*)phenomena|(.*)wildebeest|(.*)proboscises|(.*)proboscides|(.*)wildebeests|(.+)star generals)$"): {},
...
singular_recognize_rules = {
    rei(r"^(?:(.+[aeiou])o|(.+[cs])h|(.+)o|(.+[aeiou])y|(.+)x|(.+)y|(.+)z|(.+[aeiou])o|(.+[cs])h|(.+)o|(.+[aeiou])y|(.+)x|(.+)y|(.+)z|(.+[aeiou])se|(.+[aeo])lf|(.+[aiy])nx|(.+)oe|(.+)ss|(.+)us|(.+[aeiou])se|(.+[aeo])lf|(.+[aiy])nx|(.+)oe|(.+)ss|(.+)us|(.*?)'s?|(.*)cow|(.+)-ox|(.*)elf|(.*)man|(.*)pox|(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) it|(.+)oux|(.+)arf|(.+)eaf|(.+)eau|(.+)ieu|(.+)quy|(.+)nse|(.+[^ns])sis|(.*?)'s?|(.*)cow|(.+)-ox|(.*)elf|(.*)man|(.*)pox|(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) it|(.+)oux|(.+)arf|(.+)eaf|(.+)eau|(.+)ieu|(.+)quy|(.+)nse|(.+[^ns])sis|(.*)hoof|(.*)leaf|(.*)life|(.*)loaf|(.*)wife|(.*)wolf|(.*)foot|(.*)buzz|(.*)fizz|(.*)fuzz|(.*)jazz|(.*)bema|(.*)nova|(.*)bass|(.*)deer|(.*)fish|(.*)fowl|(.+)ceps|(.+)nife|(.+)orse|(.+[au])orse|(.+)trix|(.+)zoon|(.*)hoof|(.*)leaf|(.*)life|(.*)loaf|(.*)wife|(.*)wolf|(.*)foot|(.*)buzz|(.*)fizz|(.*)fuzz|(.*)jazz|(.*)bema|(.*)nova|(.*)bass|(.*)deer|(.*)fish|(.*)fowl|(.+)ceps|(.+)nife|(.+)orse|(.+[au])orse|(.+)trix|(.+)zoon|(.*)staff|(.*)stave|(.*)genus|(.*)hertz|(.*)child|(.*)knife|(.*)shelf|(.*)thief|(.*)human|(.*)goose|(.*)mouse|(.*)tooth|(.*)frizz|(.*)drama|(.*)edema|(.*)lemma|(.*)stoma|(.*)umbra|(.*)lumen|(.*)datum|(.*)helix|(.*)sheep|(.*)craft|(.*)staff|(.*)stave|(.*)genus|(.*)hertz|(.*)child|(.*)knife|(.*)shelf|(.*)thief|(.*)human|(.*)goose|(.*)mouse|(.*)tooth|(.*)frizz|(.*)drama|(.*)edema|(.*)lemma|(.*)stoma|(.*)umbra|(.*)lumen|(.*)datum|(.*)helix|(.*)sheep|(.*)craft|(.*)person|(.*)mensch|(.*)hedron|(.*)helion|(.*)person|(.*)mensch|(.*)hedron|(.*)helion|(.*)siemens|(.*)brother|(.*)sarcoma|(.*)stratum|(.*)nucleus|(.*)measles|(.*)siemens|(.*)brother|(.*)sarcoma|(.*)stratum|(.*)nucleus|(.*)measles|(.*)bacillus|(.*)bacillus|(.*)proboscis|(.*)legomenon|(.*)proboscis|(.*)legomenon|(.*)phenomenon|(.*)wildebeest|(.*)phenomenon|(.*)wildebeest|(.+)star general|(.+)star general)$"): {},
...
def convert_to_modern_plural(word, verbose=False):
    ...
    for rule in modern_plural_convert_rules:
        ...
        if match:
            ...
            if not "conditional" in modern_plural_convert_rules[rule] or modern_plural_convert_rules[rule]["conditional"](match):
...
def convert_to_classical_plural(word, verbose=False):
    ...
    for rule in classical_plural_convert_rules:
        ...
        if match:
            if verbose: print(word, 'matched', rule.pattern)
            # If there is no conditional, or if the condition succeeds
            if not "conditional" in classical_plural_convert_rules[rule] or classical_plural_convert_rules[rule]["conditional"](match):
                if verbose: print(word, 'passed the conditional, or there was no conditional')
...
def convert_to_singular(word, verbose=False):
    ...
    for rule in singular_convert_rules:
        ...
        if match:
            if verbose: print(word, 'matched', rule.pattern)
            # If there is no conditional, or if the condition succeeds
            if not "conditional" in singular_convert_rules[rule] or singular_convert_rules[rule]["conditional"](match):
                if verbose: print(word, 'passed the conditional, or there was no conditional')
