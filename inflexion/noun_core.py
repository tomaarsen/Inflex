...
modern_plural_convert_rules = {
    rei(r"^(.*?)'s?$"): {
        ...
        "output": lambda match: (lambda subword: subword + '\'' if subword.endswith('s') else subword + '\'s')(convert_to_modern_plural(match.group(1)))
    },
    ...
    rei(r"^(.+)thesis$"): {"output": lambda match: f"{match.group(1)}theses"},
    ...
    rei(r"^(.+)nge$"): {"output": lambda match: f"{match.group(1)}nges"},
    ...
    rei(r"^(.+[^aeoui][aeoui])che$"): {"output": lambda match: f"{match.group(1)}ches"},
    ...
    rei(r"^(.+[aeio])se$"): {"output": lambda match: f"{match.group(1)}ses"},
    rei(r"^(.+)ss$"): {"output": lambda match: f"{match.group(1)}sses"},
    rei(r"^(.+[rnlpw])se$"): {"output": lambda match: f"{match.group(1)}ses"},
    rei(r"^(.+[aeo])use$"): {"output": lambda match: f"{match.group(1)}uses"},
...
classical_plural_convert_rules = {
    rei(r"^(.*?)'s?$"): {
        "conditional": lambda match: is_singular(match.group(1)),
        "output": lambda match: (lambda subword: subword + '\'' if subword.endswith('s') else subword + '\'s')(convert_to_classical_plural(match.group(1)))
    },
...
singular_convert_rules = {
    rei(r"^(.*?)'s?$"): {
        ...
        "output": lambda match: (lambda subword: subword + '\'' if subword.endswith('s') else subword + '\'s')(convert_to_singular(match.group(1)))
    },
    ...
    rei(r"^(.+)theses$"): {"output": lambda match: f"{match.group(1)}thesis"},
    ...
    rei(r"^(.+)nges$"): {"output": lambda match: f"{match.group(1)}nge"},
    ...
    rei(r"^(.+)ceps$"): {"output": lambda match: f"{match.group(1)}ceps"},
    rei(r"^(.+[^aeoui][aeoui])ches$"): {"output": lambda match: f"{match.group(1)}che"},
    ...
    rei(r"^(.+[aeio])ses$"): {"output": lambda match: f"{match.group(1)}se"},
    rei(r"^(.+)sses$"): {"output": lambda match: f"{match.group(1)}ss"},
    rei(r"^(.+[rnlpw])ses$"): {"output": lambda match: f"{match.group(1)}se"},
    rei(r"^(.+[aeo])uses$"): {"output": lambda match: f"{match.group(1)}use"},
...
plural_recognize_rules = {
    rei(r"^(?:(.+)os|(.+[aeiou])ys|(.+[aeiou])os|(.+)oes|(.+)oux|(.+[rnlpw])ses|(.*)men|(.+)zoa|(.+)xes|(.*)pox|(.+)ies|(.+[aeio])ses|(.+[^ns])ses|(.+[cs])hes|(.*?)'s?|(.+)ieux|(.*)feet|(.+)sses|(.+[aiy])nxes|(.+)eaux|(.*)fowl|(.+)ieus|(.+[^aeoui][aeoui])ches|(.+)uses|(.+)eaus|(.+[aiy])nges|(.+[aeo])uses|(.*)data|(.+)ceps|(.+)nges|(.*)fish|(.+[aeo])lves|(.*)kine|(.+)zzes|(.*)mice|(.*)deer|(.*)bass|(.*)cows|(.*)geese|(.*)novas|(.*)teeth|(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) them|(.*)lives|(.*)wives|(.*)fowls|(.*)hoofs|(.*)hertz|(.+)eaves|(.*)novae|(.+)-oxen|(.*)helia|(.*)bemas|(.+)nives|(.+)quies|(.*)craft|(.*)sheep|(.*)hedra|(.*)elves|(.+)arves|(.*)jazzes|(.*)lemmas|(.*)fuzzes|(.*)humans|(.*)buzzes|(.*)hooves|(.*)staves|(.*)umbras|(.*)stomas|(.*)wolves|(.*)staffs|(.+)trixes|(.*)fizzes|(.*)basses|(.*)genera|(.*)edemas|(.*)bemata|(.*)dramas|(.*)lumens|(.*)people|(.*)strata|(.*)knives|(.+)theses|(.*)loaves|(.*)leaves|(.*)lumina|(.*)umbrae|(.+)trices|(.*)nuclei|(.*)edemata|(.*)hedrons|(.*)shelves|(.*)thieves|(.*)bacilli|(.*)persons|(.*)frizzes|(.*)measles|(.*)stomata|(.*)lemmata|(.*)helices|(.*)siemens|(.*)helions|(.*)menschen|(.*)children|(.*)sarcomas|(.*)stratums|(.*)legomena|(.*)brethren|(.*)brothers|(.*)sarcomata|(.*)phenomena|(.*)wildebeest|(.*)proboscises|(.*)proboscides|(.*)wildebeests|(.+)star generals)$"): {},
...
singular_recognize_rules = {
    rei(r"^(?:(.+[aeiou])y|(.+)z|(.+)y|(.+)x|(.+)o|(.+[aeiou])o|(.+[cs])h|(.+)ss|(.+[aeio])se|(.+)oe|(.+[aiy])nx|(.+)us|(.+[aeo])lf|(.+[rnlpw])se|(.+)oux|(.*)man|(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) it|(.+)quy|(.+[^ns])sis|(.*)elf|(.*)pox|(.+)ieu|(.+)-ox|(.*)cow|(.+)eau|(.*?)'s?|(.+)nge|(.+[^aeoui][aeoui])che|(.+[aeo])use|(.+)arf|(.+)eaf|(.*)loaf|(.*)life|(.*)jazz|(.*)hoof|(.+)nife|(.*)leaf|(.*)buzz|(.*)fowl|(.*)wolf|(.*)fizz|(.*)wife|(.*)foot|(.+)trix|(.+)ceps|(.*)bema|(.*)fish|(.+)zoon|(.*)fuzz|(.*)nova|(.*)deer|(.*)bass|(.*)stave|(.*)drama|(.*)tooth|(.*)mouse|(.*)umbra|(.*)knife|(.*)shelf|(.*)lumen|(.*)hertz|(.*)helix|(.*)child|(.*)datum|(.*)goose|(.*)thief|(.*)lemma|(.*)craft|(.*)sheep|(.*)frizz|(.*)staff|(.*)genus|(.*)stoma|(.*)edema|(.*)human|(.+)thesis|(.*)helion|(.*)person|(.*)mensch|(.*)hedron|(.*)brother|(.*)sarcoma|(.*)nucleus|(.*)stratum|(.*)measles|(.*)siemens|(.*)bacillus|(.*)legomenon|(.*)proboscis|(.*)phenomenon|(.*)wildebeest|(.+)star general)$"): {},
