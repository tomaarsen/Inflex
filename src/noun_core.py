...
modern_plural_convert_rules = {
    ...
    rei(r"(.*)louse$"): {"output": lambda match: f"{match.group(1)}lice"},
...
singular_convert_rules = {
    ...
    rei(r"(.*)lice$"): {"output": lambda match: f"{match.group(1)}louse"},
...
plural_recognize_rules = {
    ...
    rei(r"(.*)craft$"): {},
    rei(r"(.+)star generals$"): {},
    rei(r"(about|above|across|after|among|around|athwart|at|before|behind|below|beneath|besides?|between|betwixt|beyond|but|by|during|except|for|from|into|in|near|off|of|onto|on|out|over|since|till|to|under|until|unto|upon|with) them$"): {},
